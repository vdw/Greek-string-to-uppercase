...
if ( ! function_exists('grstrtoupper'))
{
	function grstrtoupper($string) {
		...
		$string = preg_match($latin_check, $string) ? strtoupper($string) : $string;
		...
		$lowercase = array_merge($letters, $letters_accent, $letters_upper_accent, $letters_upper_solvents);
		$uppercase = array_merge($letters_to_uppercase, $letters_accent_to_uppercase, $letters_upper_accent_to_uppercase, $letters_upper_solvents_to_uppercase);
